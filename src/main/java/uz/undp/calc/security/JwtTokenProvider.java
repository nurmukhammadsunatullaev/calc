...
import uz.undp.calc.exceptions.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    private List<String> getRoleNames(Set<RoleEntity> userRoles) {
        return userRoles.stream().map(RoleEntity::getAuthority).collect(Collectors.toList());
    }
}
